...
# Example Indian Financial Document
financial_text = """
Tata Consultancy Services Ltd. (NSE:TCS) reported Q3 FY24 revenue of Rs. 59,705 crores, up 4% YoY.
The company's net profit reached ₹11,735 crores in Q3, with a CASA ratio of 44.5%.
HDFC Bank's gross NPA ratio improved to 1.26% from 1.8% last quarter.
The RBI maintained repo rate at 6.5% while SEBI introduced new regulations.
NIFTY 50 reached an all-time high with market cap of Rs. 350.25 lakh crores.
SBI reported PAT of Rs. 15,477 Cr in H1 FY24 with a credit growth of 13.2% year-on-year.
"""

# Extract entities
results = extract_financial_entities(financial_text)

# Print results
print("\nFinancial Entity Recognition Results:")
for entity in results:
    print(f"Text: {entity['text']}, Entity: {entity['entity']}, Score: {entity['score']:.2f}")
